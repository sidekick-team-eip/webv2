    ...
    <section className="text-gray-600 body-font mt-8 mb-8">
      ...
      <div className="pt-12 max-w-5xl mx-auto md:px-1 px-3">
        <div className="ktq4 text-center">
          ...
          <p className="pt-2 value-text text-md text-gray-500` fkrr1">
      ...
      <div className="pt-12 max-w-6xl mx-auto fsac4 md:px-1 px-3">
        <div className="ktq5">
          <h1 className="font-bold text-black">1</h1>
          <h3 className="pt-3 font-semibold text-title-faq text-black">
            Qu'est-ce que Sidekick et en quoi consiste ce projet ?
          </h3>
          <p className="pt-2 value-text text-faq text-gray-500` fkrr1">
