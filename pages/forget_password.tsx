...
export default function ForgetPassword() {
    ...
    return (
        <div
            className="relative px-4 sm:px-6 lg:px-8 flex flex-col justify-center mx-auto w-full h-full mt-32">
          ...
          <span
              className="bg-clip-text bg-gradient-to-r from-red-500 to-orange-500 text-transparent">request your code</span>
                ...
                <span className="font-medium">
                    ...
                    <button type='submit'
                            className="mt-4 flex flex-row justify-center w-full items-center bg-orangePrimary hover:underline text-gray-800 font-bold rounded-full py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
                        ...
                        <p style={{color: 'white'}}>Send request</p>
                    </button>
