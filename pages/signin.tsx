    ...
    <div
      ...
      <div className="flex flex-col space-y-5 justify-center items-center text-center py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className='flex items-center justify-center'>
          <form className='flex flex-col space-y-6 w-[400px]' onSubmit={handleSubmit}>
            ...
            <a href="/forget_password" className="text-orange-950 hover:underline">Missing password ?</a>
          </form>
        </div>
      </div>
    </div>
